...
<body>
		...
		<div class="form_container">
			...
			<div class="form login_form">
				<form method="post" action="GetLogin">
					...
					<div class="option_field">
						...
						</span> <a href="#" class="forgot_pw">Forgot password?</a>
					</div>
			...
			<div class="form signup_form">
				<form method="post" action="CreateNewAccount">
					...
					<div class="input_box">
						<input type="email" name="email" placeholder="Enter your email" required /> <i class="uil uil-envelope-alt email"></i>
					</div>
					<div class="input_box">
						<input type="text" name="username"
							placeholder="Enter your username" required /> <i
					...
					<div class="input_box">
						<input type="number" name="age" placeholder="Enter your Age"
							required /> <i class="uil uil-envelope-alt email"></i>
					</div>
					<div class="input_box">
						<input type="password" name="password"
    ...
    document.addEventListener("DOMContentLoaded", () => {
        ...
        // Check if msg is not null and not empty
